		...
		<div class="container-fluid search-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a href="{{route('medicines')}}" class="nav-link">Catelog</a>
					</li>
					<!-- <li class="nav-item">
				...
				<ul class="top-hnt-right-content col-lg-6">
					...
					@if (Auth::check())
					<div class="auth-user ml-4">
						<div class="dropdown">
							<a class="btn-open d-flex align-items-center" href="{{route('profile')}}">
								<span class="fa fa-user" aria-hidden="true"></span>
								<h6 class="text-white m-0 ml-2">Hello {{ Auth::user()->name }}</h6>
							</a>
						</div>
						<h6 class="ml-4 m-0">
