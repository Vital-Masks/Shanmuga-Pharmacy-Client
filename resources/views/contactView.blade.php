...
<!-- contacts -->
<section class="w3l-contacts-8 py-5">
                ...
                <div class="col-lg-6 partners">
                    <div class="cont-details">
                        <h3 class="hny-title mb-0">Get in <span>touch</span></h5>
                            ...
                            <p class="margin-top"><span class="texthny">Call Us : </span> <a href="tel:+(21)
                                    224 3457">+(21)
                                    224 3457</a></p>
                            <!-- <p> <span class="texthny">Email : </span> <a href="mailto:info@example.com">
                                    info@example.com</a></p> -->
                            <p class="margin-top"> No 54 K.K.S Road Chunnagam, Jaffna </p>
                    </div>
                    <!-- <div class="hours">
